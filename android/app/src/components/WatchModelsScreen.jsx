      ...
      <View style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.row}>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try7.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try1.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
          ...
          <View style={styles.row}>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try3.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try5.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
          ...
          <View style={styles.row}>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try4.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={handleImageClick}>
              <View style={styles.imageBackground}>
                <Image
                  source={require('../assets/images/try2.jpg')}
                  style={styles.image}
                />
              </View>
            </TouchableOpacity>
        ...
        <View style={styles.button}>
          <Text style={styles.buttonText}>
            Try your favorite watch by simply clicking on it!
          </Text>
        </View>
